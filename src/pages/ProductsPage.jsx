...
const allProducts = [
    { name: 'Anthracite Coal', category: 'coal', image: '/images/prod_coal.webp', filter: 'none', desc: 'Ultra-high carbon content coal for industrial furnaces. Prized for low volatile matter and superior heat output.' },
    { name: 'PCI Coal', category: 'coal', image: '/images/prod_coal.webp', filter: 'brightness(1.1)', desc: 'Pulverized coal injection grade for blast furnace optimization, reducing coke consumption and improving efficiency.' },
  { name: 'Thermal Coal', category: 'coal', image: '/images/prod_coal.webp', filter: 'contrast(1.2)', desc: 'Energy-grade coal for power generation, cement kilns, and industrial heating applications.' },
  
  { name: 'Activated Carbon', category: 'carbon', image: '/images/prod_carbon.webp', filter: 'none', desc: 'Highly porous carbon with exceptional adsorption properties for water purification, air treatment, and chemical processing.' },
  { name: 'Carburiser', category: 'carbon', image: '/images/prod_carbon.webp', filter: 'brightness(1.15)', desc: 'High-carbon additive for steelmaking and foundry applications, ensuring precise carbon content in final products.' },
  { name: 'Carbon Raiser', category: 'carbon', image: '/images/prod_carbon.webp', filter: 'contrast(1.15)', desc: 'Premium carbon material for increasing carbon content in molten steel and iron, available in multiple grades.' },
